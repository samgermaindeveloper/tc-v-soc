...
local demina = require("love-bone.examples.util.demina");
...
function love.load()
	...
	local skeleton = demina.ImportSkeleton("love-bone/examples/assets/guy/guy_default.anim");
	...
	local animWalk = demina.ImportAnimation("love-bone/examples/assets/guy/guy_walk.anim", skeleton);
	local animPump = demina.ImportAnimation("love-bone/examples/assets/guy/guy_fistpump.anim", skeleton);
	local skinDefault = demina.ImportSkin("love-bone/examples/assets/guy/guy_default.anim", skeleton);
	local skinGuy = demina.ImportSkin("love-bone/examples/assets/guy/guy_skin.anim", skeleton);

	local gun = boner.newVisual("love-bone/examples/assets/guy/gun.png");
	...
	for i = 1, NUM_ACTORS do
		...
		data = love.sound.newSoundData("love-bone/examples/assets/guy/step.wav")
		local stepSound = love.audio.newSource( data  );
